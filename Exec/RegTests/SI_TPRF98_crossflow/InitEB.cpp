...
//  }
    ...
    cell_id = 2.121 / dy;
    amrex::EB2::PlaneIF insulator_tip({AMREX_D_DECL(0.,2.1,0.)},
                                  {AMREX_D_DECL(0.,1.,0.)});

    amrex::EB2::PlaneIF insulator_vert_left({AMREX_D_DECL(-0.225,0.,0.)},
                                  {AMREX_D_DECL(1.,0.,0)});

    amrex::EB2::PlaneIF insulator_vert_right({AMREX_D_DECL(0.225,0.,0.)},
                                   {AMREX_D_DECL(-1.,0.,0.)});
    ...
    amrex::EB2::PlaneIF cone_cathode_angle_left({AMREX_D_DECL(point1_cat[0],1.46147,0)},
                                   {AMREX_D_DECL(norm0[0],-norm0[1],0)});

    amrex::EB2::PlaneIF cone_cathode_angle_right({AMREX_D_DECL(-point1_cat[0],1.46147,0)},
                                   {AMREX_D_DECL(-norm0[0],-norm0[1],0)});
